...
@Component({
  selector: 'app-marketplace-view-completed-order',
  templateUrl: './marketplace-view-completed-order.component.html',
  styleUrls: ['./marketplace-view-completed-order.component.css']
})
export class MarketplaceViewCompletedOrderComponent implements OnInit {
