                            ...
                            if (f) this.fake(f);
                                ...
                                if (n) {
                                    ...
                                    g ? (k = f.document.$.body.createTextRange(), k.moveToElementText(g.$), v.setEndPoint("EndToEnd", k), v.moveEnd("character", -1)) : (p = b.getNext(h), r = b.hasAscendant("pre"), p = !(p && p.getText && p.getText().match(k)) && (r || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")),
                                        r = f.document.createElement("span"), r.setHtml("\x26#65279;"), r.insertBefore(b), p && f.document.createText("ï»¿").insertBefore(b));
                                    f.setStartBefore(b);
                                    b.remove();
            ...
            onLoad: function() {
                ...
                CKEDITOR.ui.dialog.textInput.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, {
                    ...
                    setValue: function(a) {
                        if (this.bidi) {
                            var b = a && a.charAt(0);
                            (b = "â€ª" == b ? "ltr" : "â€«" == b ? "rtl" : null) && (a = a.slice(1));
                ...
                if (e != CKEDITOR.DIALOG_RESIZE_NONE) {
                    ...
                    a.on("load", function() {
                        ...
                        b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + f.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(f.lang.common.resize) +
                            '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + p + ', event )"\x3e' + ("ltr" == f.lang.dir ? "â—¢" : "â—£") + "\x3c/div\x3e");
                ...
                exec: function(a) {
                    ...
                    if (e) {
                        ...
                        if (b == CKEDITOR.TRISTATE_OFF) {
                            ...
                            1 > l.length && (b = a.document.createElement(a.config.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), d = m.shift(), e.insertNode(b), b.append(new CKEDITOR.dom.text("ï»¿", a.document)), e.moveToBookmark(d), e.selectNodeContents(b), e.collapse(!0), d = e.createBookmark(), l.push(b), m.unshift(d));
                            h = l[0].getParent();
                            e = [];
                        ...
                        if (document.body.createTextRange) {
                            ...
                            try {
                                ...
                                if (k) {
                                    ...
                                    c.pasteHTML('\x3cspan id\x3d"' + y + '"\x3eâ€‹\x3c/span\x3e');
                ...
                enterBr: function(a, b, c, e) {
                    if (c = c || f(a)) {
                        ...
                        e || "li" != p ? (!e && m && h.test(p) ? (m = r.getDirection()) ? (l = l.createElement("div"), l.setAttribute("dir", m), l.insertAfter(r), c.setStart(l, 0)) : (l.createElement("br").insertAfter(r), CKEDITOR.env.gecko && l.createText("").insertAfter(r), c.setStartAt(r.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (a = "pre" == p && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? l.createText("\r") : l.createElement("br"), c.deleteContents(), c.insertNode(a), CKEDITOR.env.needsBrFiller ?
                            (l.createText("ï»¿").insertAfter(a), m && (r || u.blockLimit).appendBogus(), a.getNext().$.nodeValue = "", c.setStartAt(a.getNext(), CKEDITOR.POSITION_AFTER_START)) : c.setStartAt(a, CKEDITOR.POSITION_AFTER_END)), c.collapse(!0), c.select(), c.scrollIntoView()) : d(a, b, c, e)
                    }
                }
            };
