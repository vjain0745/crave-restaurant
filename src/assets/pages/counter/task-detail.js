...
date.days+'</h2><p class="f-18 f-w-400"> Days '+'</p></div><div class="col-xs-3"><h2 class="f-20 f-w-400">'+
this.leadingZeros(date.hours)+'</h2><p class="f-18 f-w-400">Hours</p></div><div class="col-xs-3"><h2 class="f-20 f-w-400">'+
this.leadingZeros(date.min)+'</h2><p class="f-18 f-w-400">Minutes</p></div><div class="col-xs-3"><h2 class="f-20 f-w-400">'+
this.leadingZeros(date.sec)+'</h2><p class="f-18 f-w-400">Seconds</p></div></div>';}};var Countdown=function(el,options){this.el=el;this.options={};this.interval=false;this.mergeOptions=function(options){for(var i in defaultOptions){if(defaultOptions.hasOwnProperty(i)){this.options[i]=typeof options[i]!=='undefined'?options[i]:defaultOptions[i];if(i==='date'&&typeof this.options.date!=='object'){this.options.date=new Date(this.options.date);}
